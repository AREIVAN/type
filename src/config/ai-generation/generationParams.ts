// AI Generation Configs - Index
// Export all configuration modules for AI generation
...
export { 
  spanishHintOptions, 
  blanksModeOptions, 
  defaultLearningSupport,
  difficultyEstimates,
  type LearningSupportConfig,
  type SpanishHintOption,
  type BlanksModeOption
} from './index';
